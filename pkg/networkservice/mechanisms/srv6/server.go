...
func (v *srv6Server) appendInterfaceConfig(ctx context.Context, conn *connection.Connection, connect bool) error {
	...
	dstHostLocalSID, err := mechanism.DstHostLocalSID()
	if err != nil { return err }
	hardwareAddress, err := mechanism.DstHardwareAddress()
	if err != nil { return err }
	srcBSID, err := mechanism.DstBSID()
	if err != nil { return err }
	srcLocalSID, err := mechanism.DstLocalSID()
	if err != nil { return err }
	dstLocalSID, err := mechanism.SrcLocalSID()
	if err != nil { return err }
